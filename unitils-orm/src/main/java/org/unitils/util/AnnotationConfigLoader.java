 ...
 * @param <CFG>
 *     The type of the resource configuration class
 */
abstract public class AnnotationConfigLoader<A extends Annotation, CFG extends ResourceConfig>
     ...
     *     The class of the configuring annotation, not null
     */
    ...
    protected CFG getResourceConfig(Class<?> testClass) {
        ...
        if (configuringAnnotations.size() > 1) {
            throw new UnitilsException("Class " + testClass.getSimpleName() + " has " + configuringAnnotations.size() + " configuring @"
                + annotationClass.getSimpleName() + " annotations. There can only be one such annotation per class.");
        }
     ...
     * 
     * @param configuringAnnotation
     *     Configuring annotation, if any
     * @param customConfigMethod
     ...
     *     A method annotated with {@link #annotationClass}
    ...
    /**
     * @param annotation
     *     Annotation of type {@link #annotationClass}
