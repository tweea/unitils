 ...
 * @author Filip Neven
 * @author Tim Ducheyne
 * @param <ORM_PERSISTENCE_UNIT>
 *     Type of the ORM persistence unit
 * @param <ORM_PERSISTENCE_CONTEXT>
 *     Type of the ORM persistence context
 ...
 * @param <ORM_CONFIG>
 *     Type of the value object extending {@link OrmConfig} that contains all unitils specific persitence unit configuration
 ...
 */
abstract public class OrmModule<ORM_PERSISTENCE_UNIT, ORM_PERSISTENCE_CONTEXT, PROVIDER_CONFIGURATION_OBJECT, PERSISTENCE_UNIT_CONFIG_ANNOTATION extends Annotation, ORM_CONFIG extends OrmConfig, ORM_PERSISTENCE_UNIT_CONFIG_LOADER extends ResourceConfigLoader<ORM_CONFIG>>
    ...
    protected ConfiguredOrmPersistenceUnit<ORM_PERSISTENCE_UNIT, PROVIDER_CONFIGURATION_OBJECT> getConfiguredPersistenceUnit(Object testObject) {
        ...
        if (persistenceUnitConfig == null) {
            throw new UnitilsException(
                "Could not find a configuring @" + getPersistenceUnitConfigAnnotationClass().getSimpleName() + " annotation or custom config method");
        }

        // Look for a cached instance. If not available, a new instance is created and added to the cache
        ConfiguredOrmPersistenceUnit<ORM_PERSISTENCE_UNIT, PROVIDER_CONFIGURATION_OBJECT> configuredPersistenceUnit = configuredOrmPersistenceUnitCache
     ...
     *
     * @param activePersistenceContext
     *     Active persistence context, associated with the current transaction, not null
     */
