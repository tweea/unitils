...
public interface JpaProviderSupport {
     ...
     * 
     * @param entityManager
     *     Currently active <code>EntityManager</code>, not null
     * @param configurationObject
     *     Provider specific configuration object, not null
     */
     ...
     *     The JPA <code>PersistenceProvider</code> that was used for creating the
