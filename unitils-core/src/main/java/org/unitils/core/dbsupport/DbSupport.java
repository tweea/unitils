...
abstract public class DbSupport {
     ...
     *     The name of the DBMS implementation that is supported by this implementation, not null
     */
     ...
     *     The stored case: possible values 'lower_case', 'upper_case', 'mixed_case' and 'auto'
    ...
    private StoredIdentifierCase determineStoredIdentifierCase(String storedIdentifierCase) {
        if ("lower_case".equals(storedIdentifierCase)) {
            ...
            throw new UnitilsException("Unknown value " + storedIdentifierCase + " for property " + PROPKEY_STORED_IDENTIFIER_CASE
     ...
     *     The string to quote identifiers, 'none' if quoting is not supported, 'auto' for auto detection
