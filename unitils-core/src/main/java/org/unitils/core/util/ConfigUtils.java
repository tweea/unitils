...
public class ConfigUtils {
     ...
     * @param configuration
     *     The configuration containing the necessary properties for configuring the instance
     ...
     */
    public static <T extends Configurable> T getConfiguredInstanceOf(Class<? extends T> type, Properties configuration,
