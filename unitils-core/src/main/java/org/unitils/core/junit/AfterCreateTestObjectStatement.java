...
public class AfterCreateTestObjectStatement
    extends Statement {
    ...
    public AfterCreateTestObjectStatement(TestListener unitilsTestListener, Statement nextStatement, Object testObject) {
