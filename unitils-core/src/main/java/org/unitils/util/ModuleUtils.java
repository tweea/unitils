...
public class ModuleUtils {
     ...
     *
     * @param moduleClass
     *     The class of the module for which we want the default annotation property values
     * @param configuration
    ...
    public static Map<Class<? extends Annotation>, Map<String, String>> getAnnotationPropertyDefaults(Class<? extends Module> moduleClass,
        Properties configuration, Class<? extends Annotation>... annotationClasses) {
        Map<Class<? extends Annotation>, Map<String, String>> result = new HashMap<>();
     ...
     */
    public static String getAnnotationPropertyDefault(Class<? extends Module> moduleClass, Class<? extends Annotation> annotationClass, String name,
     ...
     */
    public static <T extends Enum<?>> T getEnumValueReplaceDefault(Class<? extends Annotation> annotation, String annotationPropertyName, T enumValue,
     ...
     * @return the enumValue or the defaultValue in case of a default
     */
    public static Class<?> getClassValueReplaceDefault(Class<? extends Annotation> annotation, String annotationPropertyName, Class<?> value,
        Map<Class<? extends Annotation>, Map<String, String>> allDefaultValues, Class<?> defaultValueClass) {
        String valueAsString = getValueAsStringReplaceDefault(annotation, annotationPropertyName, value.getName(), allDefaultValues,
            defaultValueClass.getName());
     ...
     *     the annotation property for which the value must be replaced, not null
     * @param valueAsString
     *     the value to check, not null
     * @param allDefaultValues
     *     the map with values to return in case of a default, not null
     * @param defaultValueName
     *     the name of the default value, eg DEFAULT, not null @return the enumValue or the defaultValue in case of a default
    ...
    private static String getValueAsStringReplaceDefault(Class<? extends Annotation> annotation, String annotationProperty, String valueAsString,
        ...
        throw new UnitilsException("Could not replace default value. No default value found for annotation: " + annotation + ", property " + annotationProperty
