...
public class ObservedInvocationsReport
     ...
     *     The invocations for which to create a report, not null
     ...
     * @return The string representation, not null
     */
    protected String formatObservedInvocation(ObservedInvocation observedInvocation, List<FormattedObject> currentLargeObjects,
        ...
        if (argumentTypes.length > 0) {
            ...
            for (Class<?> argumentType : argumentTypes) {
                result.append(formatValue(argumentsAtInvocationTime.next(), arguments.next(), argumentType, currentLargeObjects, allLargeObjects,
                    largeObjectNameIndexes));
                result.append(", ");
            }
