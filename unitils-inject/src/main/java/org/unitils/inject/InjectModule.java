...
public class InjectModule
    ...
    public void init(Properties configuration) {
        defaultAnnotationPropertyValues = getAnnotationPropertyDefaults(InjectModule.class, configuration, InjectInto.class, InjectIntoStatic.class,
            InjectIntoByType.class, InjectIntoStaticByType.class);
     ...
     *     The tested object field, not null
     */
    protected void createObjectForField(Object testObject, Field testedObjectField) {
        ...
        if (declaredClass.isInterface()) {
            ...
            logger.warn("Field " + testedObjectField.getName() + " (annotated with @TestedObject) has type "
                + testedObjectField.getDeclaringClass().getSimpleName() + " which is an abstract class. It is not automatically instantiated.");
        } else {
            try {
     ...
     *
     * @param test
     *     The instance to inject into, not null
     */
     ...
     * {@link #storeValueToRestoreAfterTest(Class, String, Class, org.unitils.inject.util.PropertyAccess, Object, org.unitils.inject.util.Restore)}.
     */
     ...
     *     The instance to inject into, not null
     * @param fieldToInject
     *     The field from which the value is injected into the target, not null
     */
    protected void inject(Object test, Field fieldToInject) {
        ...
        if (targets.size() == 0) {
            throw new UnitilsException(getSituatedErrorMessage(InjectInto.class, fieldToInject,
                "The target should either be specified explicitly using the target property, or by using the @" + TestedObject.class.getSimpleName()
                    + " annotation"));
        }
     ...
     *
     * @param test
     *     Instance to inject into, not null
    ...
    protected void injectByType(Object test, Field fieldToInject) {
        ...
        PropertyAccess propertyAccess = getEnumValueReplaceDefault(InjectIntoByType.class, "propertyAccess", injectIntoByTypeAnnotation.propertyAccess(),
    ...
    protected void injectStaticByType(Object test, Field fieldToAutoInjectStatic) {
        ...
        Restore restore = getEnumValueReplaceDefault(InjectIntoStaticByType.class, "restore", injectIntoStaticByTypeAnnotation.restore(),
            defaultAnnotationPropertyValues);
     ...
     * @param property
     *     The OGNL expression that defines where the object will be injected, null for auto inject
     * @param fieldType
     *     The type, not null
     * @param propertyAccess
     *     The access type in case auto injection is used
     * @param oldValue
     *     The value that was replaced during the injection
     * @param restore
     *     The type of reset, not DEFAULT
     */
    protected void storeValueToRestoreAfterTest(Class<?> targetClass, String property, Class<?> fieldType, PropertyAccess propertyAccess, Object oldValue,
        Restore restore) {
     ...
     *
     * @param annotationClass
     *     The injection annotation, not null
     * @param annotatedField
     *     The annotated field, not null
    ...
    protected String getSituatedErrorMessage(Class<? extends Annotation> annotationClass, Field annotatedField, String errorDescription) {
        return "Error while processing @" + annotationClass.getSimpleName() + " annotation on field " + annotatedField.getName() + " of class "
            + annotatedField.getDeclaringClass().getSimpleName() + ": " + errorDescription;
    }
    ...
    protected class InjectTestListener
         ...
         *     The test method, not null
         * @param throwable
         *     The throwable thrown during the test, null if none was thrown
         */
        @Override
