...
public class ApplicationContextManager
     ...
     *     The factory for creating <code>ApplicationContext</code>s, not null.
     */
    ...
    public ApplicationContext getApplicationContext(Object testObject) {
        ...
        if (applicationContext == null) {
            throw new UnitilsException("No configuration found for creating an ApplicationContext for test " + testObject.getClass()
                + ". Make sure that you either specify a value " + "for an @" + annotationClass.getSimpleName()
                + " annotation somewhere in the testclass or a superclass or that you specify a custom create method in the test class itself.");
        }
     ...
     * 
     * @param locations
     *     The locations where to find configuration files, not null
