...
public class ProfileModuleTest {
    ...
    public void testGetProfile() {
        ...
        genCtx.load(new String[] {
            "classpath:applicationContext-dao-test.xml"
        });
        genCtx.refresh();

        EasyMockUnitils.replay();
        profileModule.setConfigurationAsTypeSpringApplicationContext(genCtx, configProfile, new String[] {
            "classpath:applicationContext-dao-test.xml"
        });
    }
    ...
    public void testGetProfileConfiguration() {
        ...
        env.setActiveProfiles(new String[] {
            "acc"
        });
    ...
    public void testGetProfileSpringApplicationContext() {
        ...
        ReflectionAssert.assertLenientEquals("Test if the actual context is a GenericXmlApplicationContext", GenericXmlApplicationContext.class,
            profileModule.getCtx().getClass());
    }

    @Test
    public void testGetProfileWithAnnotations() {
        profileModule.getProfile(TestClass6.class);
        ReflectionAssert.assertLenientEquals("Test if the actual context is a GenericXmlApplicationContext", AnnotationConfigApplicationContext.class,
            profileModule.getCtx().getClass());
