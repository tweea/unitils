...
public class ObservedInvocationsReportTest {
    ...
    public void twoMockInvocations() {
        ...
        assertTrue(result.contains(
            "1. testMock.testMethod1(\"value1\") -> null  .....  at org.unitils.mock.report.impl.ObservedInvocationsReportTest.twoMockInvocations(ObservedInvocationsReportTest.java:"));
        assertTrue(result.contains(
            "2. testMock.testMethod2()  .....  at org.unitils.mock.report.impl.ObservedInvocationsReportTest.twoMockInvocations(ObservedInvocationsReportTest.java:"));
    }
    ...
    public void largeArgumentValue_shouldBeReplacedByShortName() {
        ...
        String result = observedInvocationsView.createReport(getCurrentScenario().getObservedInvocations());
        assertTrue(result.contains(
            "1. testMock.testMethod1(string1) -> null  .....  at org.unitils.mock.report.impl.ObservedInvocationsReportTest.largeArgumentValue_shouldBeReplacedByShortName(ObservedInvocationsReportTest.java:"));
    }
    ...
    public void largeResultValue_shouldBeReplacedByShortName() {
        ...
        String result = observedInvocationsView.createReport(getCurrentScenario().getObservedInvocations());
        assertTrue(result.contains(
            "1. testMock.testMethod1(null) -> string1  .....  at org.unitils.mock.report.impl.ObservedInvocationsReportTest.largeResultValue_shouldBeReplacedByShortName(ObservedInvocationsReportTest.java:"));
    }
    ...
    public void sameInstanceLargeValueInResultAndArgument_shouldUseSameName() {
        ...
        String result = observedInvocationsView.createReport(getCurrentScenario().getObservedInvocations());
        assertTrue(result.contains(
            "1. testMock.testMethod3(list1) -> list1  .....  at org.unitils.mock.report.impl.ObservedInvocationsReportTest.sameInstanceLargeValueInResultAndArgument_shouldUseSameName(ObservedInvocationsReportTest.java:"));
    }
