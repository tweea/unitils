...
public class DetailedObservedInvocationsReportTest {
    ...
    public void twoMockInvocations() {
        ...
        assertTrue(result.contains(
            "- Observed at org.unitils.mock.report.impl.DetailedObservedInvocationsReportTest.twoMockInvocations(DetailedObservedInvocationsReportTest.java:"));
    ...
    public void largeResultValue_shouldBeReplacedByShortName() {
        ...
        assertTrue(result.contains("- string1 -> \"012345678901234567891\""));
        assertTrue(result.contains(
            "- Observed at org.unitils.mock.report.impl.DetailedObservedInvocationsReportTest.largeResultValue_shouldBeReplacedByShortName(DetailedObservedInvocationsReportTest.java:"));
        assertTrue(result.contains(
            "- Behavior defined at org.unitils.mock.report.impl.DetailedObservedInvocationsReportTest.largeResultValue_shouldBeReplacedByShortName(DetailedObservedInvocationsReportTest.java:"));
    }
    ...
    public void sameInstanceLargeValueInResultAndArgument_shouldUseSameName() {
        ...
        assertTrue(result.contains(
            "- Observed at org.unitils.mock.report.impl.DetailedObservedInvocationsReportTest.sameInstanceLargeValueInResultAndArgument_shouldUseSameName(DetailedObservedInvocationsReportTest.java:"));
        assertTrue(result.contains(
            "- Behavior defined at org.unitils.mock.report.impl.DetailedObservedInvocationsReportTest.sameInstanceLargeValueInResultAndArgument_shouldUseSameName(DetailedObservedInvocationsReportTest.java:"));
