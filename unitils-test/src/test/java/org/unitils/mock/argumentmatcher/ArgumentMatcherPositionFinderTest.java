...
public class ArgumentMatcherPositionFinderTest {
    ...
    private int invocationLineNr = 168;
    ...
    public void noArguments() {
        List<Integer> result = getArgumentMatcherIndexes(TestClass.class, "test", noArgumentsProxyMethod, noArgumentsInvocationLineNr,
            noArgumentsInvocationLineNr, 1);
        assertTrue(result.isEmpty());
    }

    @Test
    public void twoInvocationsWithSameNameOnSameLine_first() {
        List<Integer> result = getArgumentMatcherIndexes(TestClass.class, "test", proxyMethod, twoSameInvocationsOnSameLineLineNr,
            twoSameInvocationsOnSameLineLineNr, 1);
    ...
    public void twoInvocationsWithSameNameOnSameLine_last() {
        List<Integer> result = getArgumentMatcherIndexes(TestClass.class, "test", proxyMethod, twoSameInvocationsOnSameLineLineNr,
            twoSameInvocationsOnSameLineLineNr, 2);
        assertReflectionEquals(asList(2), result);
    }

    @Test
    public void twoInvocationsWithDifferentNameOnSameLine_first() {
        List<Integer> result = getArgumentMatcherIndexes(TestClass.class, "test", proxyMethod, twoDifferentInvocationsOnSameLineLineNr,
            twoDifferentInvocationsOnSameLineLineNr, 1);
        assertReflectionEquals(asList(0), result);
    }

    @Test
    public void twoInvocationsWithDifferentNameOnSameLine_last() {
        List<Integer> result = getArgumentMatcherIndexes(TestClass.class, "test", valueReturningProxyMethod, twoDifferentInvocationsOnSameLineLineNr,
            twoDifferentInvocationsOnSameLineLineNr, 1);
        assertReflectionEquals(asList(2), result);
    }
