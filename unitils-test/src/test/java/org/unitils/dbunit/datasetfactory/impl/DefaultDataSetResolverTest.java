 ...
 * @author Filip Neven
 */
public class DefaultDataSetResolverTest
     ...
     */
    @Test
    public void testResolve_noPackagePrefix()
        throws Exception {
        defaultDataSetResolver.init(configuration);
     ...
     */
    @Test
    public void testResolve_packagePrefixDisabled()
        throws Exception {
     ...
     */
    @Test
    public void testResolve_pathPrefix()
        throws Exception {
     ...
     */
    @Test
    public void testResolve_absolutePathPrefix()
        throws Exception {
        String directory = new File(
            DefaultDataSetResolver.class.getClassLoader().getResource("org/unitils/DefaultDataSetResolverTest-otherPackage.xml").toURI()).getParent();
