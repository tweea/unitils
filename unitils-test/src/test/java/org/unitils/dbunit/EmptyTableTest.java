...
public class EmptyTableTest {
    ...
    public void testEmptyTable() {
        ...
        SqlAssert.assertSingleRowSqlResult("select * from person where personID='6'", new String[] {
            "6", "Willemijn"
        });
        SqlAssert.assertSingleRowSqlResult("select * from person where personID='8'", new String[] {
            "8", "Myrthe"
        });
    }
