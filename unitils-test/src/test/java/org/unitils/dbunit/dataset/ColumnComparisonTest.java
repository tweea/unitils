...
public class ColumnComparisonTest {
    ...
    @Test
    public void differentStringValue()
        throws Exception {
        Column expectedValue = new Column("column", VARCHAR, "value");
    ...
    @Test
    public void differentDateValue()
        throws Exception {
    ...
    @Test
    public void differentDoubleValue()
        throws Exception {
        Column expectedValue = new Column("column", VARCHAR, "-1.00");
