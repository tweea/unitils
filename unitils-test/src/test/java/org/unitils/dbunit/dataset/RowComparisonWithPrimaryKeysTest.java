 ...
 * @author Filip Neven
 */
public class RowComparisonWithPrimaryKeysTest
    ...
    @Test
    public void testEqualPrimaryKey()
        throws Exception {
    ...
    @Test
    public void testEqualPrimaryKeyButOnlyPartInExpected()
        throws Exception {
        addColumn(expectedRow, "pk1", "value1");
        addPrimaryKeyColumn(actualRow, "pk1", "value1");
        addPrimaryKeyColumn(actualRow, "pk2", "value2");
    ...
    @Test
    public void testDifferentPrimaryKey()
        throws Exception {
        addColumn(expectedRow, "pk1", "value1");
    ...
    public void testAddingTwoPrimaryKeyColumnsForSameName()
        throws Exception {
