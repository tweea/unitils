 ...
 * @since 3.3
 */
public class DefaultFileContentReaderTest
    ...
    @Test
    public void firstConversionStrategyHasTargetType()
        throws Exception {
    ...
    @Test
    public void conversionStrategyHasAssignableTargetType()
        throws Exception {
    ...
    public void noConversionStrategyFoundForTargetType()
        throws Exception {
        defaultFileContentReader.readFileContent("fileName", Set.class, "utf-8", DefaultFileContentReader.class);
    }

    @Test
    public void useDefaultEncodingWhenEncodingIsNull()
        throws Exception {
    ...
    @Test
    public void useDefaultFileNameIfFileNameIsNull()
        throws Exception {
    ...
    @Test(expected = UnitilsException.class)
    public void exceptionDuringReading()
        throws Exception {
    ...
    @Test(expected = UnitilsException.class)
    public void exceptionDuringConversion()
        throws Exception {
