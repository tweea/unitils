 ...
 * @since 3.3
 */
public class FileContentAnnotationHandlerTest
    ...
    public void defaultValues() {
        ...
        fileContentReaderMock.returns(testProperties).readFileContent(isNull(String.class), Properties.class, isNull(String.class),
            DefaultValuesTestClass.class);
