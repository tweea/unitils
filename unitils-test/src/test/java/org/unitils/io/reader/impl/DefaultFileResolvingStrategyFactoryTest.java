...
public class DefaultFileResolvingStrategyFactoryTest {
    ...
    public void defaultSetup() {
        DefaultFileResolvingStrategy fileResolvingStrategy = (DefaultFileResolvingStrategy) defaultFileResolvingStrategyFactory
            .createFileResolvingStrategy(properties);
