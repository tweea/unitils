...
public class FileResolverTest {
    ...
    @Test
    public void noPackagePrefixWhenFileNameStartsWithSlash()
        throws Exception {
    ...
    @Test
    public void packagePrefixWhenClassIsInDefaultPackage()
        throws Exception {
    ...
    @Test
    public void packagePrefixingDisabled()
        throws Exception {
    ...
    @Test
    public void pathPrefixWithoutSlashIsRelativeToClassPath()
        throws Exception {
    ...
    @Test
    public void pathPrefixWithSlashIsAbsolute()
        throws Exception {
