...
public class DbSupportTest
    ...
    private static Logger logger = LoggerFactory.getLogger(DbSupportTest.class);
     ...
     */
    @Test
    public void testGetTableNames_noFound()
        throws Exception {
        cleanupTestDatabase();
     ...
     */
    @Test
    public void testGetViewNames_noFound()
        throws Exception {
        cleanupTestDatabase();
        Set<String> result = dbSupport.getViewNames();
        assertTrue(result.isEmpty());
     ...
     */
    @Test
    public void testGetSynonymNames_noFound()
        throws Exception {
        if (!dbSupport.supportsSynonyms()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testGetSequenceNames_noFound()
        throws Exception {
        if (!dbSupport.supportsSequences()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testGetTriggerNames()
        throws Exception {
        ...
        if ("mysql".equals(dbSupport.getDatabaseDialect())) {
            ...
            assertLenientEquals(asList(dbSupport.quoted("test_trigger") + " ON " + dbSupport.qualified("Test_CASE_Table"),
                dbSupport.quoted("Test_CASE_Trigger") + " ON " + dbSupport.qualified("Test_CASE_Table")), result);
        } else {
     ...
     */
    @Test
    public void testGetTriggerNames_noFound()
        throws Exception {
        if (!dbSupport.supportsTriggers()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testGetTypeNames_noFound()
        throws Exception {
        if (!dbSupport.supportsTypes()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testGetIdentityColumnNames()
        throws Exception {
     ...
     */
    @Test
    public void testIncrementSequenceToValue()
        throws Exception {
        if (!dbSupport.supportsSequences()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testIncrementIdentityColumnToValue()
        throws Exception {
        if (!dbSupport.supportsIdentityColumns()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testGetCurrentValueOfSequence()
        throws Exception {
        if (!dbSupport.supportsSequences()) {
            logger.warn("Test is not for current dialect. Skipping test.");
            return;
     ...
     */
    @Test
    public void testRemoveReferentialConstraints()
        throws Exception {
     ...
     */
    @Test
    public void testRemoveReferentialConstraints_noTablesFound()
        throws Exception {
        cleanupTestDatabase();
        dbSupport.disableReferentialConstraints();
    }
     ...
     */
    @Test
    public void testRemoveValueConstraints()
        throws Exception {
     ...
     */
    @Test
    public void testRemoveValueConstraints_noTablesFound()
        throws Exception {
        cleanupTestDatabase();
        dbSupport.disableValueConstraints();
    }
     ...
     * Creates all test database structures (view, tables...)
     */
    private void createTestDatabaseH2()
        throws Exception {
        // create tables
        // create tables
        executeUpdate("create table test_table (col1 varchar(10) not null primary key, col2 varchar(12) not null)", dataSource);
     ...
     * "drop table ... cascade" (yet, as of Derby 10.3)
     */
    private void cleanupTestDatabaseH2()
        throws Exception {
        dropTestTables(dbSupport, "test_table", "\"Test_CASE_Table\"");
        dropTestViews(dbSupport, "test_view", "\"Test_CASE_View\"");
        // dropTestSynonyms(dbSupport, "test_synonym", "\"Test_CASE_Synonym\"");
