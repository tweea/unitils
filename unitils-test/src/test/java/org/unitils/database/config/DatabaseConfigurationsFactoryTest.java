...
public class DatabaseConfigurationsFactoryTest {
    ...
    public void setUp()
        ...
        config1 = new DatabaseConfiguration("database1", "hsqldb", "org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:unitils1", "sa", null, "public",
            Arrays.asList("public"), false, true);
        config2 = new DatabaseConfiguration("database2", "hsqldb", "org.hsqldb.jdbcDriver", "jdbc:hsqldb:mem:unitils2", "sa", null, "public",
