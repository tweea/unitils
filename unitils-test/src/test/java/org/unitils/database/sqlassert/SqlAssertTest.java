...
import static org.unitils.database.sqlassert.SqlAssert.assertMultipleRowSqlResult;
import static org.unitils.database.sqlassert.SqlAssert.assertSingleRowSqlResult;

/**
 * @author Jeroen Horemans
 */
public class SqlAssertTest
    ...
    public void triggerSqlException() {
        assertSingleRowSqlResult("select * from not_existing_random_table", dataSource, new String[] {
            "one", "1"
        });
    }
    ...
    public void assertSingleRowSqlResultMainSucces() {
        assertSingleRowSqlResult(SQL_SELECT_STATEMENT_ONE_ROW, dataSource, new String[] {
            "one", "1"
        });
    }
    ...
    public void assertMultipleRowSqlResultTestMainSuccesOtherImpl() {
        assertMultipleRowSqlResult(SQL_SELECT_STATEMENT, dataSource, new String[] {
            "one", "1"
        }, new String[] {
            "two", "2"
        });
