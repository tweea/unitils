...
public class DefaultDBCleanerTest
     ...
     */
    @Test
    public void testCleanDatabase_preserveDbVersionTable()
        throws Exception {
    ...
    private void cleanupTestDatabase() {
        ...
        dropTestTables(dbSupport, "TEST_TABLE", "TEST_TABLE_PRESERVE", dbSupport.quoted("Test_CASE_Table"), dbSupport.quoted("Test_CASE_Table_Preserve"),
            versionTableName);
    }
