 ...
 * @author Tim Ducheyne
 */
public class UnitilsJUnit4ParameterizedTest_TestClass2
    ...
    public UnitilsJUnit4ParameterizedTest_TestClass2(int number) {
        this.number = number;
    }

    @BeforeClass
    public static void beforeClass() {
        registerTestInvocation(TEST_BEFORE_CLASS, UnitilsJUnit4ParameterizedTest_TestClass2.class, null);
    }

    @AfterClass
    public static void afterClass() {
        registerTestInvocation(TEST_AFTER_CLASS, UnitilsJUnit4ParameterizedTest_TestClass2.class, null);
    }
