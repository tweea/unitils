...
/**
 * JUnit 5 test class containing 2 test methods. This test test-class is used in the JUnitUnitilsInvocationTest tests.
 *
 * @author Tim Ducheyne
 */
public class UnitilsJUnit5Test_TestClass2
    extends UnitilsJUnit5TestBase {
    @BeforeAll
    public static void beforeClass() {
        registerTestInvocation(TEST_BEFORE_CLASS, UnitilsJUnit5Test_TestClass2.class, null);
    }

    @AfterAll
    public static void afterClass() {
        registerTestInvocation(TEST_AFTER_CLASS, UnitilsJUnit5Test_TestClass2.class, null);
    }
