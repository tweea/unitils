    ...
    public void exceptionWhenValueNotOfCorrectType() throws Exception {
        try {
            ...
            assertEquals("Unable to execute statement: 'select other from my_table where value = 111'.\n" +
                    "Reason: BadSqlGrammarException: StatementCallback; bad SQL grammar [select other from my_table where value = 111]; nested exception is java.sql.SQLSyntaxErrorException: incompatible data type in conversion: from SQL type VARCHAR to java.lang.Integer, value: xxx", e.getMessage());
        }
    }
